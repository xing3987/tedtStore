    ...
    <div id="leftsidebar_box" class="lf">
        ...
        <dl class="address">
            ...
            <dl class="count_managment">
                ...
                <dd class="first_dd"><a href="${pageContext.request.contextPath}/main/showPersonInfo.do">我的信息</a></dd>
                <dd><a href="${pageContext.request.contextPath}/main/showPersonal.do">安全管理</a></dd>
            </dl>
    </div>